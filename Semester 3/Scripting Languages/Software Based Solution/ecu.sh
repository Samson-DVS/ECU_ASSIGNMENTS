 ...
 
{
    ...
    #downloading image and savind them in the desired path
 
    if ! wget -q https://secure.ecu.edu.au/service-centres/MACSC/gallery/152/DSC0$digit.jpg; then
 
         echo "File Not Found please check the name entered"
    ...
    #mv DSC0$digit.jpg  /home/${current_user}/Desktop/Samson
 
    echo "----------------PROGRAM FINISHED-----------------"
 
    mv DSC0$digit.jpg ./Samson    
